...
function parseRailRow(
  ...
  const totalDist = readNum(
    row,
    "Total distance/yr",
    "TotalDistance",
    "total distance",
  );
  const intensity = readNum(
    row,
    "Energy intensity",
    "EnergyIntensity",
    "intensity",
...
function parseGenericRow(
  ...
  const unit =
    readStr(row, "Unit", "unit", "EF unit", "Intensity unit") || "Unknown";
